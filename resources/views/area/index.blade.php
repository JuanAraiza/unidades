...
<div class="col-md-3" /><a class="btn btn-primary" href="{{ route('area.create') }}">Nueva Area</a></div>
...
Dependencia
        ...
        @endforeach
            ...
            <td><a href="{{ route('area.edit', $area->id) }}" class="btn btn-warning"><span  class="fas fa-pencil"></span></a></td>
            <td><form class="delete-form" action="{{ route('area.destroy', $area->id) }}" method="post">
                @csrf
                @method('PUT')
